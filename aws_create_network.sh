...
subnet_id1a=$(aws ec2 create-subnet --vpc-id $vpc_id --cidr-block 10.0.0.0/19 --availability-zone us-east-1a | jq -r .Subnet.SubnetId)
subnet_id1b=$(aws ec2 create-subnet --vpc-id $vpc_id --cidr-block 10.0.160.0/19 --availability-zone us-east-1b | jq -r .Subnet.SubnetId)
subnet_id1c=$(aws ec2 create-subnet --vpc-id $vpc_id --cidr-block 10.0.64.0/19 --availability-zone us-east-1c | jq -r .Subnet.SubnetId)
...
aws2 ec2 authorize-security-group-ingress --group-id $knox_sg_id --protocol tcp --port 22 --cidr 0.0.0.0/0 >> /dev/null 2>&1
aws2 ec2 authorize-security-group-ingress --group-id $knox_sg_id --protocol tcp --port 443 --cidr 0.0.0.0/0 >> /dev/null 2>&1
aws2 ec2 authorize-security-group-ingress --group-id $knox_sg_id --protocol tcp --port 443 --cidr 52.36.110.208/32 >> /dev/null 2>&1
aws2 ec2 authorize-security-group-ingress --group-id $knox_sg_id --protocol tcp --port 443 --cidr 52.40.165.49/32 >> /dev/null 2>&1
aws2 ec2 authorize-security-group-ingress --group-id $knox_sg_id --protocol tcp --port 443 --cidr 35.166.86.177/32 >> /dev/null 2>&1
aws2 ec2 authorize-security-group-ingress --group-id $knox_sg_id --protocol tcp --port 9443 --cidr 0.0.0.0/0 >> /dev/null 2>&1
aws2 ec2 authorize-security-group-ingress --group-id $knox_sg_id --protocol tcp --port 9443 --cidr 52.36.110.208/32 >> /dev/null 2>&1
aws2 ec2 authorize-security-group-ingress --group-id $knox_sg_id --protocol tcp --port 9443 --cidr 52.40.165.49/32 >> /dev/null 2>&1
...
aws2 ec2 authorize-security-group-ingress --group-id $default_sg_id --protocol tcp --port 22 --cidr 0.0.0.0/0 >> /dev/null 2>&1
aws2 ec2 authorize-security-group-ingress --group-id $default_sg_id --protocol tcp --port 443 --cidr 0.0.0.0/0 >> /dev/null 2>&1
aws2 ec2 authorize-security-group-ingress --group-id $default_sg_id --protocol tcp --port 443 --cidr 52.36.110.208/32 >> /dev/null 2>&1
aws2 ec2 authorize-security-group-ingress --group-id $default_sg_id --protocol tcp --port 443 --cidr 52.40.165.49/32 >> /dev/null 2>&1
aws2 ec2 authorize-security-group-ingress --group-id $default_sg_id --protocol tcp --port 443 --cidr 35.166.86.177/32 >> /dev/null 2>&1
aws2 ec2 authorize-security-group-ingress --group-id $default_sg_id --protocol tcp --port 9443 --cidr 0.0.0.0/0 >> /dev/null 2>&1
aws2 ec2 authorize-security-group-ingress --group-id $default_sg_id --protocol tcp --port 9443 --cidr 52.36.110.208/32 >> /dev/null 2>&1
aws2 ec2 authorize-security-group-ingress --group-id $default_sg_id --protocol tcp --port 9443 --cidr 52.40.165.49/32 >> /dev/null 2>&1
